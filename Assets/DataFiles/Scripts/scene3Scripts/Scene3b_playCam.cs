...
public class Scene3b_playCam : MonoBehaviour
{
    ...
    private void PlayCamera1()
    {
        ...
        //Renderer rend = GameObject.FindGameObjectWithTag("web").GetComponent<Renderer>();
        //rend.material.mainTexture = backCam;
        quad1.GetComponent<Renderer>().material.mainTexture = backCam;
        quad1.transform.localScale = new Vector3(unitsWide, unitsTall, 1f);
